...
function gmpInitStickyItem() {
  jQuery(window).scroll(function () {
    ...
    if (wasSticking) {
      if (jQuery('#gmpPopupGoToTop').length) jQuery('#gmpPopupGoToTop').show();
    } else if (wasUnSticking) {
      if (jQuery('#gmpPopupGoToTop').length) jQuery('#gmpPopupGoToTop').hide();
    }
  });
}
