 ...
 */ !(function (e) {
  ...
  function (e, t, o) {
    ...
    ((t.__esModule = !0),
      ...
      (t.position_names = { before: n.Before, after: n.After, inside: n.Inside, none: n.None }),
        ...
        return (
          ...
          (e.prototype.moveItem = function (e) {
            ...
            if (this.current_item && this.hovered_area && this.hovered_area.position !== s.Position.None && this.canMoveToArea(this.hovered_area)) {
              ...
              this.tree_widget._triggerEvent('tree.move', { move_info: { moved_node: o, target_node: n, position: s.getPositionName(r), previous_parent: i, do_move: a, original_event: e.original_event } }).isDefaultPrevented() || a();
            }
          }),
        ...
        return (
          ...
          (t.prototype._selectNode = function (e, t) {
            ...
            if ((void 0 === t && (t = !1), this.select_node_handler)) {
              ...
              if (o.options.onCanSelectNode ? o.options.selectable && o.options.onCanSelectNode(e) : o.options.selectable) {
                if (this.select_node_handler.isNodeSelected(e)) t && (this._deselectCurrentNode(), this._triggerEvent('tree.select', { node: null, previous_node: e }));
                else {
                  var r = this.getSelectedNode();
                  (this._deselectCurrentNode(), this.addToSelection(e), this._triggerEvent('tree.select', { node: e, deselected_node: r }), (i = e.parent) && i.parent && !i.is_open && o.openNode(i, !1));
                }
                var i;
                n();
              }
          ...
          (t.prototype._loadDataFromUrl = function (e, t, o) {
            ...
            return (
              ...
              a ? (a instanceof Array ? void d(a) : ((n = 'string' == typeof a ? { url: a } : (a.method || (a.method = 'get'), a)), void s.ajax(s.extend({}, n, { method: null != a.method ? a.method.toUpperCase() : 'GET', cache: !1, dataType: 'json', success: h, error: u })))) : void l()
            );
          }),
