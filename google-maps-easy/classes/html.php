...
class htmlGmp
{
  ...
  public static function ajaxfile($name, $params = ['url' => '', 'value' => '', 'fid' => '', 'buttonName' => ''])
  {
    ...
    if (strpos($params['url'], 'pl=' . GMP_CODE) === false) {
      $params['url'] = uriGmp::_(['baseUrl' => $params['url'], 'pl' => GMP_CODE]);
    }
  ...
  {
    return self::hidden('_wpnonce', ['value' => wp_create_nonce('gmp_nonce')]);
  }
