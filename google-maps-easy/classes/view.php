  ...
  public static function getAllowedHtml()
  {
    if (empty(self::$_allowedHtml)) {
      ...
      $allowedDiv = [
        ...
        'span' => ['style' => 1, 'title' => 1, 'align' => 1, 'class' => 1, 'width' => 1, 'height' => 1, 'id' => 1],
        ...
        'select' => ['name' => 1, 'checked' => 1, 'disabled' => 1, 'selected' => 1, 'multiple' => 1, 'style' => 1, 'title' => 1, 'align' => 1, 'class' => 1, 'width' => 1, 'height' => 1, 'id' => 1],
