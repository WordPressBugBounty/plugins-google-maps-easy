...
if ($this->isPro) {
  ...
  if (frameGmp::_()->getModule('custom_controls') && method_exists(frameGmp::_()->getModule('custom_controls'), 'isCustSearchAndMarkersPeriodAvailable') && frameGmp::_()->getModule('custom_controls')->isCustSearchAndMarkersPeriodAvailable()) {
    $isCustSearchAndMarkersPeriodAvailable = true;
  }
}
?>
             ...
             htmlGmp::input('map_opts[width]', [
               ...
               'attrs' => 'style="width: 100%;" id="map_opts_width"',
										...
										<div class="sup-col sup-w-75">
											<label class="supsystic-tooltip" title="<?php _e('Pixels', GMP_LANG_CODE); ?>" style="margin-right: 15px; position: relative; top: 7px;"><?php echo htmlGmp::wpKsesHtml(
  htmlGmp::radiobutton('map_opts[width_units]', [
    'value' => 'px',
    'checked' => $this->editMap ? htmlGmp::checkedOpt($this->map['params'], 'width_units', 'px') : false,
  ]),
); ?>&nbsp;<?php _e('Px', GMP_LANG_CODE); ?></label>
											<label style="margin-right: 15px; position: relative; top: 7px;"><?php echo htmlGmp::wpKsesHtml(
             htmlGmp::radiobutton('map_opts[width_units]', [
               'value' => '%',
             ...
             'Your map height.' .
               ...
               '</ul>' .
               'Recalculation will be done for maps in page content and widgets except of maps which displaying in Easy Google Maps widget popup (Display as image mode).',
             GMP_LANG_CODE,
           ); ?>
										</span>
									</th>
              ...
              htmlGmp::input('map_opts[height]', [
                ...
                'attrs' => 'style="width: 100%;" id="map_opts_height"',
											...
											<div class="sup-col sup-w-50 no-p">
												<label class="supsystic-tooltip" title="<?php _e('Pixels', GMP_LANG_CODE); ?>" style="margin-right: 15px; position: relative; top: 7px;"><?php echo htmlGmp::wpKsesHtml(
  htmlGmp::radiobutton('map_opts_height_units_is_constant', [
    'value' => 'px',
    'checked' => true,
  ]),
); ?>&nbsp;<?php _e('Px', GMP_LANG_CODE); ?></label>
										...
										<div class="gmpAdditionalHeightOpts sup-col sup-w-100 no-p">
											<div style="margin-top: 8px;">
												<?php echo htmlGmp::wpKsesHtml(
              htmlGmp::checkboxHiddenVal('map_opts[adapt_map_to_screen_height]', [
                'value' => $this->editMap && isset($this->map['params']['adapt_map_to_screen_height']) ? esc_attr($this->map['params']['adapt_map_to_screen_height']) : false,
											...
											<div class="gmpAdditionalAdaptHeightOpts">
												<div style="margin-top: 8px;">
													...
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::text('map_opts[selectors][content_before]', [
                 ...
                 'attrs' => 'style="width: 100%;" id="map_opts_selector_content_before"',
												...
												<div style="margin-top: 8px;">
													...
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::text('map_opts[selectors][content_after]', [
...
?>
									...
									<tr>
										...
										<td>
											<div class="sup-col sup-w-50">
												<?php echo htmlGmp::wpKsesHtml(
              htmlGmp::selectbox('map_opts[type_control]', [
                'options' => ['none' => __('None', GMP_LANG_CODE), 'DROPDOWN_MENU' => __('Dropdown Menu', GMP_LANG_CODE), 'HORIZONTAL_BAR' => __('Horizontal Bar', GMP_LANG_CODE)],
                ...
                'attrs' => 'style="width: 100%;" id="map_opts_type_control"',
											...
											<div class="sup-col sup-w-50">
												...
												<?php echo htmlGmp::wpKsesHtml(
              htmlGmp::selectbox('map_opts[type_control_position]', [
									...
									<tr>
										...
										<td>
											<div>
												<div class="sup-col sup-w-50">
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::selectbox('map_opts[zoom_control]', [
                 'options' => ['none' => __('None', GMP_LANG_CODE), 'DEFAULT' => __('Default', GMP_LANG_CODE) /*, 'LARGE' => __('Large', GMP_LANG_CODE), 'SMALL' => __('Small', GMP_LANG_CODE)*/],
                 ...
                 'attrs' => 'style="width: 100%;" id="map_opts_zoom_control"',
												...
												<div class="sup-col sup-w-50">
													...
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::selectbox('map_opts[zoom_control_position]', [
                 'options' => $this->positionsList,
                 ...
                 'attrs' => 'data-for="zoomControlOptions" class="gmpMapPosChangeSelect ' . esc_attr($addProElementClass) . '"' . (empty($addProElementAttrs && 1 == 0) ? '' : sprintf($addProElementAttrs, $proLink, $proLink)),
									...
									<tr>
										...
										<td>
											<div class="sup-col sup-w-50">
												<?php echo htmlGmp::wpKsesHtml(
              htmlGmp::checkboxHiddenVal('map_opts[street_view_control]', [
                'value' => $this->editMap && isset($this->map['params']['street_view_control']) ? esc_attr($this->map['params']['street_view_control']) : true,
											...
											<div class="sup-col sup-w-50">
												...
												<?php echo htmlGmp::wpKsesHtml(
              htmlGmp::selectbox('map_opts[street_view_control_position]', [
                'options' => $this->positionsList,
										...
										<td colspan="2" style="padding: 0;">
											<table class="form-table">
												<tr>
													...
													<td>
														<?php echo htmlGmp::wpKsesHtml(
                htmlGmp::checkboxHiddenVal('map_opts[draggable]', [
                ...
                'Sometimes you need to disable possibility to zoom your map using mouse wheel. This can be required for example - if you need to use your wheel for some other action, for example scroll your site even if mouse is over your map.',
                GMP_LANG_CODE,
              ); ?>"></i>
													</th>
													<td>
														<?php echo htmlGmp::wpKsesHtml(
                htmlGmp::checkboxHiddenVal('map_opts[mouse_wheel_zoom]', [
                  'value' => $this->editMap && isset($this->map['params']['mouse_wheel_zoom']) ? esc_attr($this->map['params']['mouse_wheel_zoom']) : true,
												...
												<tr>
													...
													<td>
														<?php echo htmlGmp::wpKsesHtml(
                htmlGmp::checkboxHiddenVal('map_opts[dbl_click_zoom]', [
                  'value' => $this->editMap && isset($this->map['params']['dbl_click_zoom']) ? esc_attr($this->map['params']['dbl_click_zoom']) : true,
													...
													<td>
														<?php echo htmlGmp::wpKsesHtml(
                htmlGmp::checkboxHiddenVal('map_opts[is_static]', [
									...
									<tr>
										...
										<td>
											<div>
												...
												<?php echo htmlGmp::wpKsesHtml(
              htmlGmp::text('map_opts[map_center][address]', [
                ...
                'attrs' => 'style="width: 100%;" id="map_opts_map_center_address"',
											...
											<div class="sup-col sup-w-50" style="margin-top: 10px;">
												...
												<?php echo htmlGmp::wpKsesHtml(
              htmlGmp::text('map_opts[map_center][coord_x]', [
                ...
                'attrs' => 'style="width: 100%;" id="map_opts_map_center_coord_x"',
											...
											<div class="sup-col sup-w-50" style="margin-top: 10px;">
												...
												<?php echo htmlGmp::wpKsesHtml(
              htmlGmp::text('map_opts[map_center][coord_y]', [
           ...
           ?>
											<?php echo htmlGmp::wpKsesHtml(
             htmlGmp::selectbox('map_opts[zoom_type]', [
               'options' => ['zoom_level' => __('Preset Zoom', GMP_LANG_CODE), 'fit_bounds' => __('Fit Bounds', GMP_LANG_CODE)],
											...
											<div id="zoom_type_options">
												<div>
													<div class="zoom_level sup-col sup-w-50" style="margin-top: 10px;">
														...
														<?php echo htmlGmp::wpKsesHtml(
                htmlGmp::selectbox('map_opts[zoom]', [
                  'options' => $zoomRange,
                  ...
                  'attrs' => 'style="width: 100%;"',
														...
														<?php
//echo htmlGmp::hidden('map_opts[zoom]', array('value' => $this->editMap ? $this->map['params']['zoom'] : ''))
?>
													</div>
													<div class="zoom_level sup-col sup-w-50" style="margin-top: 10px;">
														...
														<?php echo htmlGmp::wpKsesHtml(
                htmlGmp::selectbox('map_opts[zoom_mobile]', [
                  'options' => $zoomRange,
                  ...
                  'attrs' => 'style="width: 100%;"',
												...
												<div>
													<div class="zoom_min_level sup-col sup-w-50" style="margin-top: 10px;">
														...
														<?php echo htmlGmp::wpKsesHtml(
                htmlGmp::selectbox('map_opts[zoom_min]', [
                  'options' => $zoomRange,
                  ...
                  'attrs' => 'style="width: 100%;"',
													...
													<div class="zoom_max_level sup-col sup-w-50" style="margin-top: 10px;">
														...
														<?php echo htmlGmp::wpKsesHtml(
                htmlGmp::selectbox('map_opts[zoom_max]', [
                  'options' => $zoomRange,
                  ...
                  'attrs' => 'style="width: 100%;"',
									...
									<tr>
										...
										<td>
											<?php echo htmlGmp::wpKsesHtml(
             htmlGmp::selectbox('map_opts[map_type]', [
               'options' => ['ROADMAP' => __('Road Map', GMP_LANG_CODE), 'HYBRID' => __('Hybrid', GMP_LANG_CODE), 'SATELLITE' => __('Satellite', GMP_LANG_CODE), 'TERRAIN' => __('Terrain', GMP_LANG_CODE)],
               ...
               'attrs' => 'style="width: ' . ($this->isPro ? '100%' : 'calc(100% - 200px)') . ';" id="map_opts_map_stylization"',
									...
									<tr>
										<th scope="row">
											...
											<i style="float: right;" class="fa fa-question supsystic-tooltip" title="<?php _e(
             'If you have many markers - you can have a problems with viewing them when zoom out for example: they will just cover each-other. Marker clusterization can solve this problem by grouping your markers in groups when they are too close to each-other.',
             GMP_LANG_CODE,
           ); ?>"></i>
										</th>
										<td>
											<?php
           echo htmlGmp::wpKsesHtml(
             htmlGmp::selectbox('map_opts[marker_clasterer]', [
               'options' => ['none' => __('None', GMP_LANG_CODE), 'MarkerClusterer' => __('Base Clusterization', GMP_LANG_CODE)],
           ...
           $curClusterIconWidth = $this->editMap && isset($this->map['params']['marker_clasterer_icon_width']) && $this->map['params']['marker_clasterer_icon_width'] ? esc_attr($this->map['params']['marker_clasterer_icon_width']) : 53;
           $curClusterIconHeight = $this->editMap && isset($this->map['params']['marker_clasterer_icon_height']) && $this->map['params']['marker_clasterer_icon_height'] ? esc_attr($this->map['params']['marker_clasterer_icon_height']) : 52;
           ?>
											<div id="gmpMarkerClastererSubOpts" style="display: none;">
												<div class="gmpClastererSubOpts">
													...
													<?php echo htmlGmp::hidden('map_opts[marker_clasterer_icon]', ['value' => esc_attr($curClusterIcon)]); ?>
													<?php echo htmlGmp::hidden('map_opts[marker_clasterer_icon_width]', ['value' => esc_attr($curClusterIconWidth)]); ?>
													<?php echo htmlGmp::hidden('map_opts[marker_clasterer_icon_height]', ['value' => esc_attr($curClusterIconHeight)]); ?>
													<div style="clear: both;"></div>
												</div>
												<div class="gmpClastererSubOpts">
													...
													<div class="sup-col sup-w-75">
														<?php echo htmlGmp::wpKsesHtml(
                htmlGmp::text('map_opts[marker_clasterer_grid_size]', [
                  ...
                  'attrs' => 'style="width: 100%;" id="gmpMarkerClastererGridSize" ',
									...
									<tr>
										...
										<td>
											...
											<?php echo htmlGmp::wpKsesHtml(
             htmlGmp::hidden('map_opts[markers_list_type]', [
											...
											<div id="gmpMapMarkersListSettings" style="display: none;">
												<div style="margin-top: 10px;clear: both;">
													<div class="sup-col sup-w-50">
														...
														<?php echo htmlGmp::wpKsesHtml(
                htmlGmp::colorpicker('map_opts[markers_list_color]', [
                  'value' => $this->editMap && isset($this->map['params']['markers_list_color']) ? esc_attr($this->map['params']['markers_list_color']) : '#55BA68',
													...
													<div class="sup-col sup-w-50">
														...
														<?php echo htmlGmp::wpKsesHtml(
                htmlGmp::checkboxHiddenVal('map_opts[markers_list_hide_empty_block]', [
                  ...
                  'attrs' => 'id="map_opts_markers_list_hide_empty_block"',
												...
												<div style="margin-top: 10px;clear: both;">
													<div class="sup-col sup-w-50">
														...
														<?php echo htmlGmp::wpKsesHtml(
                htmlGmp::checkboxHiddenVal('map_opts[markers_list_collapse][mobile]', [
                  ...
                  'attrs' => 'id="map_opts_markers_list_collapse_mobile"',
													...
													<div class="sup-col sup-w-50">
                                                        ...
                                                        <?php echo htmlGmp::wpKsesHtml(
                                                          htmlGmp::checkboxHiddenVal('map_opts[markers_list_loop]', [
                   ...
                   GMP_LANG_CODE,
												...
												<div style="clear: both;">
													<div class="sup-col sup-w-50">
														...
														<?php echo htmlGmp::wpKsesHtml(
                htmlGmp::checkboxHiddenVal('map_opts[markers_list_autoplay][enable]', [
                  ...
                  'attrs' => 'id="map_opts_markers_list_autoplay_enable"',
													...
													<div class="sup-col sup-w-50">
														...
														<?php echo htmlGmp::wpKsesHtml(
                htmlGmp::text('map_opts[markers_list_autoplay][steps]', [
                  ...
                  'attrs' => 'style="width: 100%;" id="map_opts_markers_list_autoplay_steps" placeholder="1"',
												...
												<div style="clear: both;">
													<div class="sup-col sup-w-50">
														...
														<?php echo htmlGmp::wpKsesHtml(
                htmlGmp::text('map_opts[markers_list_autoplay][idle]', [
                  ...
                  'attrs' => 'style="width: 100%;" id="map_opts_markers_list_autoplay_idle" placeholder="3000"',
													...
													<div class="sup-col sup-w-50">
														...
														<?php echo htmlGmp::wpKsesHtml(
                htmlGmp::text('map_opts[markers_list_autoplay][duration]', [
                  ...
                  'attrs' => 'style="width: 100%;" id="map_opts_markers_list_autoplay_duration" placeholder="160"',
									...
									<tr>
										...
										<td>
											<?php echo htmlGmp::wpKsesHtml(
             htmlGmp::checkboxHiddenVal('map_opts[enable_trafic_layer]', [
               ...
               'attrs' => 'class="gmpProOpt"',
									...
									<tr>
										<th scope="row">
											...
											<i style="float: right;" class="fa fa-question supsystic-tooltip" title="<?php _e(
             'Display the public transit network of a city on your map. When the Transit Layer is enabled, and the map is centered on a city that supports transit information, the map will display major transit lines as thick, colored lines.',
             GMP_LANG_CODE,
           ); ?>"></i>
											<?php if (!$this->isPro) { ?>
										...
										<td>
											<?php echo htmlGmp::wpKsesHtml(
             htmlGmp::checkboxHiddenVal('map_opts[enable_transit_layer]', [
             ...
             GMP_LANG_CODE,
										...
										<td>
											<?php echo htmlGmp::wpKsesHtml(
             htmlGmp::checkboxHiddenVal('map_opts[enable_bicycling_layer]', [
										...
										<td>
											<div style="margin-top: 10px;">
												<label for="map_opts_enable_google_kml_api">
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::checkboxHiddenVal('map_opts[enable_google_kml_api]', [
           ...
           ?>
											<div style="margin-top: 10px;" class="<?php echo $hiddenClass; ?>" >
												<label for="map_opts_enable_kml_filter">
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::checkboxHiddenVal('map_opts[enable_kml_filter]', [
                 ...
                 'attrs' => 'class="gmpProOpt" id="map_opts_enable_kml_filter"',
											...
											<div id="gmpKmlFileRowExample" class="gmpKmlFileRow" style="display: none; margin-top: 10px;">
												...
												<label class="gmpShowSublayersLabel" style="float: right;">
													<?php echo htmlGmp::wpKsesHtml(htmlGmp::hidden('map_opts[kml_filter][show_sublayers][]', ['value' => '', 'attrs' => 'class="gmpShowSublayersInput gmpProOpt" disabled="disabled"'])); ?>
             ...
             foreach ($this->map['params']['kml_import_to_marker'] as $omKey => $oneMarker) {
               ...
               echo htmlGmp::wpKsesHtml(
                 htmlGmp::hidden('map_opts[kml_import_to_marker][]', [
             ...
             htmlGmp::checkboxHiddenVal('map_opts[enable_custom_map_controls]', [
               ...
               'attrs' => 'class="gmpProOpt" onclick="gmpAddCustomControlsOptions()"',
											...
											<div id="custom_controls_options" style="display: none;">
												...
												<?php echo htmlGmp::wpKsesHtml(
              htmlGmp::selectbox('map_opts[custom_controls_type]', [
                'options' => ['gmpSquareControls' => __('Square', GMP_LANG_CODE), 'gmpRoundedEdgesControls' => __('Rounded edges', GMP_LANG_CODE), 'gmpRoundControls' => __('Round', GMP_LANG_CODE)],
                ...
                'attrs' => 'class="gmpProOpt" style="width: 100%;" id="map_opts_custom_controls_type"',
												...
												<div style="margin-top: 10px;">
													...
													<?php if (!$this->isPro) { ?>
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::colorpicker('map_opts[custom_controls_bg_color]', [
                 'attrs' => 'class="gmpProOpt"',
                ...
                htmlGmp::colorpicker('map_opts[custom_controls_bg_color]', [
                  'value' => $this->editMap && isset($this->map['params']['custom_controls_bg_color']) ? esc_attr($this->map['params']['custom_controls_bg_color']) : '#55BA68',
												...
												<?php if (!$this->isPro) { ?>
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::colorpicker('map_opts[custom_controls_txt_color]', [
                 'attrs' => 'class="gmpProOpt"',
               ...
               htmlGmp::colorpicker('map_opts[custom_controls_txt_color]', [
                 'value' => $this->editMap && isset($this->map['params']['custom_controls_txt_color']) ? esc_attr($this->map['params']['custom_controls_txt_color']) : '#000000',
												...
												<div style="margin-top: 10px;">
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::checkboxHiddenVal('map_opts[custom_filter_show_all]', [
                 ...
                 'attrs' => 'class="gmpProOpt"',
												...
												<div style="margin-top: 10px;">
													...
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::selectbox('map_opts[custom_controls_unit]', [
                 ...
                 'attrs' => 'class="gmpProOpt" style="width: 100%;" id="map_opts_custom_controls_unit"',
												...
												<div style="margin-top: 10px;">
													...
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::selectbox('map_opts[custom_controls_position]', [
                 'options' => $this->positionsList,
                 ...
                 'attrs' => 'class="gmpProOpt" style="width: 100%;" id="map_opts_custom_controls_position"',
												...
												<div style="margin-top: 10px;">
													...
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::text('map_opts[custom_controls_slider_min]', [
                 ...
                 'attrs' => 'class="gmpProOpt" style="width: 100%;" id="map_opts_custom_controls_slider_min"',
												...
												<div style="margin-top: 10px;">
													...
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::text('map_opts[custom_controls_slider_max]', [
                 ...
                 'attrs' => 'class="gmpProOpt" style="width: 100%;" id="map_opts_custom_controls_slider_max"',
												...
												<div style="margin-top: 10px;">
													...
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::text('map_opts[custom_controls_slider_step]', [
                 ...
                 'attrs' => 'class="gmpProOpt" style="width: 100%;" id="map_opts_custom_controls_slider_step"',
												...
												<div style="margin-top: 10px;">
													...
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::selectbox('map_opts[custom_controls_search_country]', [
                 'options' => array_merge(['' => 'All Countries'], $this->countries),
                 ...
                 'attrs' => 'class="gmpProOpt" style="width: 100%;" id="map_opts_custom_controls_search_country"',
												...
												<div style="margin-top: 10px;">
													<label>
														<?php
              $isCustomSearchParamArr = [];
              if (!empty($this->map['params']['custom_controls_improve_search']) && $this->map['params']['custom_controls_improve_search'] == 1) {
                $isCustomSearchParamArr = ['checked' => 'checked'];
              }
              ...
              ?>
												...
												<div class="gmpImprSearchSubOpt" style="display: none; margin-top: 10px;">
													<label>
														<?php
              $isSearchExtend = [];
              if (!empty($this->map['params']['button_search_extend']) && $this->map['params']['button_search_extend'] == 1) {
                $isSearchExtend = ['checked' => 'checked'];
              }
              ...
              ?>
												...
												<div style="margin-top: 10px;">
													<label>
														<?php
              $isFilterEnable = [];
              if (!empty($this->map['params']['button_filter_enable']) && $this->map['params']['button_filter_enable'] == 1) {
                $isFilterEnable = ['checked' => 'checked'];
              }
              ...
              ?>
									...
									<tr>
										...
										<td>
											<?php echo htmlGmp::wpKsesHtml(
             htmlGmp::checkboxHiddenVal('map_opts[enable_full_screen_btn]', [
               ...
               'attrs' => 'class="gmpProOpt"',
									...
									<tr>
										...
										<td>
											<?php echo htmlGmp::wpKsesHtml(
             htmlGmp::checkboxHiddenVal('map_opts[hide_poi]', [
               ...
               'attrs' => 'class="gmpProOpt"',
									...
									<tr>
										...
										<td>
											<?php echo htmlGmp::wpKsesHtml(
             htmlGmp::checkboxHiddenVal('map_opts[hide_countries]', [
               ...
               'attrs' => 'class="gmpProOpt"',
									...
									<tr>
										...
										<td>
											<?php echo htmlGmp::wpKsesHtml(
             htmlGmp::checkboxHiddenVal('map_opts[hide_marker_tooltip]', [
               'value' => $this->editMap && isset($this->map['params']['hide_marker_tooltip']) ? esc_attr($this->map['params']['hide_marker_tooltip']) : false,
									...
									<tr>
										...
										<td>
											<?php echo htmlGmp::wpKsesHtml(
             htmlGmp::checkboxHiddenVal('map_opts[center_on_cur_marker_infownd]', [
               ...
               'attrs' => '',
									...
									<tr>
										...
										<td>
											<?php echo htmlGmp::wpKsesHtml(
             htmlGmp::checkboxHiddenVal('map_opts[center_on_cur_user_pos]', [
               ...
               'attrs' => 'class="gmpProOpt"',
											...
											<div id="gmpCurUserPosOptions" style="margin-top: 10px; display: none;">
												<?php echo htmlGmp::wpKsesHtml(
              htmlGmp::hidden('map_opts[center_on_cur_user_pos_icon]', [
                'value' => $this->editMap && isset($this->map['params']['center_on_cur_user_pos_icon']) ? esc_attr($this->map['params']['center_on_cur_user_pos_icon']) : 1 /*Default Icon ID*/,
              ]),
            ); ?>
               ...
               'You can add markers at the current map with the frontend using the form, which can be displayed using the shortcode (it placed below preview map). Additional options that affect the operation of the form:' .
                 ...
                 "<br /><br />You can add markers at the current map with the frontend using the form, which can be displayed using the shortcode. Please place this shortcode at the same page as it's map map. Please note that the page will be overloaded after adding marker.",
               GMP_LANG_CODE,
             ); ?>
												</span>
											<?php if (!$this->isPro) { ?>
										...
										<td>
											<?php echo htmlGmp::wpKsesHtml(
             htmlGmp::checkboxHiddenVal('map_opts[frontend_add_markers]', [
               ...
               htmlGmp::text('gmpCopyTextCode', [
                 ...
                 'attrs' => 'class="gmpCopyTextCode gmpMapMarkerFormCodeShell gmpStaticWidth" style="width: 100%; text-align: center;"',
												...
												<div style="margin-top: 10px;">
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::checkboxHiddenVal('map_opts[frontend_add_markers_logged_in_only]', [
                 ...
                 'attrs' => 'class="gmpProOpt" id="map_opts_frontend_add_markers_logged_in_only"',
												...
												<div style="margin-top: 10px;">
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::checkboxHiddenVal('map_opts[frontend_add_markers_disable_wp_editor]', [
                 ...
                 'attrs' => 'class="gmpProOpt" id="map_opts_frontend_add_markers_disable_wp_editor"',
												...
												<div style="margin-top: 10px;">
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::checkboxHiddenVal('map_opts[frontend_add_markers_delete_markers]', [
                 ...
                 'attrs' => 'class="gmpProOpt" id="map_opts_frontend_add_markers_delete_markers"',
												...
												<div style="margin-top: 10px;">
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::checkboxHiddenVal('map_opts[frontend_add_markers_use_markers_categories]', [
                 ...
                 'attrs' => 'class="gmpProOpt" id="map_opts_frontend_add_markers_use_markers_categories"',
												...
												<div style="margin-top: 10px;">
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::checkboxHiddenVal('map_opts[frontend_add_markers_use_limits]', [
                 ...
                 'attrs' => 'class="gmpProOpt" id="map_opts_frontend_add_markers_use_limits"',
												...
												<div id="gmpUseLimitsForMarkerAddingOptions" style="display: none; margin-top: 10px;">
													<div class="sup-col sup-w-50">
														...
														<?php echo htmlGmp::wpKsesHtml(
                htmlGmp::text('map_opts[frontend_add_markers_use_count_limits]', [
                  ...
                  'attrs' => 'style="width: 100%;" id="map_opts_frontend_add_markers_use_count_limits"',
													...
													<div class="sup-col sup-w-50">
														...
														<?php echo htmlGmp::wpKsesHtml(
                htmlGmp::text('map_opts[frontend_add_markers_use_time_limits]', [
            ...
            ?>
										...
										<td>
											<?php echo htmlGmp::wpKsesHtml(
             htmlGmp::checkboxHiddenVal('map_opts[places][en_toolbar]', [
               ...
               htmlGmp::text('gmpCopyTextCode', [
                 ...
                 'attrs' => 'class="gmpCopyTextCode gmpPlacesToolbarCodeShell gmpStaticWidth" style="width: 100%; text-align: center;"',
												...
												<div style="margin-top: 10px;">
													...
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::text('map_opts[places][slider_min]', [
                 ...
                 'attrs' => 'class="gmpProOpt" style="width: 100%;" id="map_opts_places_slider_min"',
												...
												<div style="margin-top: 10px;">
													...
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::text('map_opts[places][slider_max]', [
                 ...
                 'attrs' => 'class="gmpProOpt" style="width: 100%;" id="map_opts_places_slider_max"',
												...
												<div style="margin-top: 10px;">
													...
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::text('map_opts[places][slider_step]', [
                 ...
                 'attrs' => 'class="gmpProOpt" style="width: 100%;" id="map_opts_places_slider_step"',
									...
									<tr>
										...
										<td>
											<?php echo htmlGmp::wpKsesHtml(
             htmlGmp::colorpicker('map_opts[marker_filter_color]', [
               ...
               'attrs' => 'id="map_opts_marker_filter_color"',
									...
									<tr>
										...
										<td>
											<?php echo htmlGmp::wpKsesHtml(
             htmlGmp::text('map_opts[marker_filter_button_title]', [
               ...
               'attrs' => 'id="map_opts_marker_filter_button_title"',
									...
									<tr>
										...
										<td>
											<?php echo htmlGmp::wpKsesHtml(
             htmlGmp::checkboxHiddenVal('map_opts[marker_filter_show_all_parents]', [
               ...
               'attrs' => 'id="map_opts_marker_filter_show_all_parents"',
									...
									<tr>
										...
										<td>
											<?php echo htmlGmp::wpKsesHtml(
             htmlGmp::selectbox('map_opts[marker_infownd_type]', [
               'options' => dispatcherGmp::applyFilters('addInfoWindowStyles', ['' => __('Default', GMP_LANG_CODE), 'rounded_edges' => __('Rounded Edges', GMP_LANG_CODE)]),
               ...
               'attrs' => 'style="width: 100%;" id="map_opts_marker_infownd_type"',
											...
											<div id="gmpMarkerInfoWndTypeSubOpts">
												<div class="gmpSubOpt" data-type="rounded_edges" style="display: none; margin-top: 10px;">
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::checkboxHiddenVal('map_opts[marker_infownd_hide_close_btn]', [
          ...
          ?>
											<div class="sup-col" style="padding-right: 0px;">
												<label for="map_opts_marker_infownd_width_units" style="margin-right: 15px; position: relative; top: <?php echo esc_attr($markersInfoWndWidthUnitsLabelStyle); ?>;">
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::radiobutton('map_opts[marker_infownd_width_units]', [
                 'value' => 'auto',
               ...
               htmlGmp::radiobutton('map_opts[marker_infownd_width_units]', [
                 ...
                 'checked' => $this->editMap && $markersInfoWndWidthUnits ? htmlGmp::checkedOpt($this->map['params'], 'marker_infownd_width_units', 'px') : false,
											...
											<div class="sup-col sup-w-25">
												<?php echo htmlGmp::wpKsesHtml(
              htmlGmp::text('map_opts[marker_infownd_width]', [
           ...
           ?>
											<div class="sup-col" style="padding-right: 0px;">
												<label for="map_opts_marker_infownd_height_units" style="margin-right: 15px; position: relative; top: <?php echo esc_attr($markersInfoWndHeightUnitsLabelStyle); ?>;">
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::radiobutton('map_opts[marker_infownd_height_units]', [
                 'value' => 'auto',
               ...
               htmlGmp::radiobutton('map_opts[marker_infownd_height_units]', [
                 ...
                 'checked' => $this->editMap && $markersInfoWndHeightUnits ? htmlGmp::checkedOpt($this->map['params'], 'marker_infownd_height_units', 'px') : false,
											...
											<div class="sup-col sup-w-25">
												<?php echo htmlGmp::wpKsesHtml(
              htmlGmp::text('map_opts[marker_infownd_height]', [
                ...
                'attrs' => 'style="width: 100%; display: ' . esc_attr($markersInfoWndHeightInputViewStyle) . ';"',
									...
									<tr>
										...
										<td>
											<?php echo htmlGmp::wpKsesHtml(
             htmlGmp::colorpicker('map_opts[marker_title_color]', [
               'value' => $this->editMap && isset($this->map['params']['marker_title_color']) ? esc_attr($this->map['params']['marker_title_color']) : '#A52A2A',
									...
									<tr>
										...
										<td>
											<?php echo htmlGmp::wpKsesHtml(
             htmlGmp::colorpicker('map_opts[marker_infownd_bg_color]', [
               'value' => $this->editMap && isset($this->map['params']['marker_infownd_bg_color']) ? esc_attr($this->map['params']['marker_infownd_bg_color']) : '#FFFFFF',
									...
									<tr>
										...
										<td>
											<div class="sup-col sup-w-25">
												<?php echo htmlGmp::wpKsesHtml(
              htmlGmp::text('map_opts[marker_title_size]', [
                ...
                'attrs' => 'style="width: 100%;" id="map_opts_marker_title_size"',
											...
											<div class="sup-col sup-w-75">
												<label class="supsystic-tooltip" title="<?php _e('Pixels', GMP_LANG_CODE); ?>" style="margin-right: 15px; position: relative; top: 7px;">
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::radiobutton('map_opts[marker_title_size_units]', [
                 'value' => 'px',
                 'checked' => true,
               ]),
             ); ?>&nbsp;<?php _e('Px', GMP_LANG_CODE); ?></label>
									...
									<tr style="border-bottom: 1px solid #e3dbdb!important;">
										...
										<td>
											<div class="sup-col sup-w-25">
												<?php echo htmlGmp::wpKsesHtml(
              htmlGmp::text('map_opts[marker_desc_size]', [
                ...
                'attrs' => 'style="width: 100%;" id="map_opts_marker_desc_size"',
											...
											<div class="sup-col sup-w-75">
												<label class="supsystic-tooltip" title="<?php _e('Pixels', GMP_LANG_CODE); ?>" style="margin-right: 15px; position: relative; top: 7px;">
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::radiobutton('map_opts[marker_desc_size_units]', [
                 'value' => 'px',
                 'checked' => true,
               ]),
             ); ?>&nbsp;<?php _e('Px', GMP_LANG_CODE); ?></label>
            ...
            ?>
										...
										<td>
											<?php echo htmlGmp::wpKsesHtml(
             htmlGmp::checkboxHiddenVal('map_opts[enable_directions_btn]', [
               ...
               'attrs' => 'class="gmpProOpt"',
											...
											<div id="gmpDirectionsOptions" style="margin-top: 10px; display: none;">
												<div style="margin-top: 10px;">
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::checkboxHiddenVal('map_opts[directions_alternate_routes]', [
                 ...
                 'attrs' => 'class="gmpProOpt"',
												...
												<div style="margin-top: 10px;">
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::checkboxHiddenVal('map_opts[directions_data_show]', [
                 ...
                 'attrs' => 'class="gmpProOpt"',
												...
												<div style="margin-top: 10px;">
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::checkboxHiddenVal('map_opts[directions_steps_show]', [
                 ...
                 'attrs' => 'class="gmpProOpt"',
												...
												<div style="margin-top: 10px;">
													<?php echo htmlGmp::wpKsesHtml(
               htmlGmp::checkboxHiddenVal('map_opts[directions_miles]', [
                 ...
                 'attrs' => 'class="gmpProOpt"',
									...
									<tr>
										...
										<td>
											<?php echo htmlGmp::wpKsesHtml(
             htmlGmp::checkboxHiddenVal('map_opts[enable_infownd_print_btn]', [
               ...
               'attrs' => 'class="gmpProOpt"',
							...
							<?php echo htmlGmp::wpKsesHtml(htmlGmp::hidden('mod', ['value' => 'gmap'])); ?>
							<?php echo htmlGmp::wpKsesHtml(htmlGmp::hidden('action', ['value' => 'save'])); ?>
							<?php echo htmlGmp::defaultNonceForAdminPanel(); ?>
							<?php echo htmlGmp::wpKsesHtml(htmlGmp::hidden('map_opts[id]', ['value' => $this->editMap ? esc_attr($this->map['id']) : ''])); ?>
						</form>
					</div>
						...
						<form id="gmpMarkerForm">
							<table class="form-table">
								<tr>
									...
									<td>
										<?php echo htmlGmp::wpKsesHtml(
            htmlGmp::text('marker_opts[title]', [
              'value' => '',
            ...
            'textarea_rows' => 10,
										...
										<?php echo htmlGmp::wpKsesHtml(htmlGmp::hidden('marker_opts[description]', ['value' => ''])); ?>
									</th>
								</tr>
								...
								<tr>
									...
									<td>
										<?php echo htmlGmp::wpKsesHtml(
            htmlGmp::hidden('marker_opts[icon]', [
              'value' => 1 /*Default Icon ID*/,
								...
								<tr>
									...
									<td>
										<?php echo htmlGmp::wpKsesHtml(
            htmlGmp::text('marker_opts[address]', [
              'value' => '',
              'placeholder' => '603 Park Avenue, Brooklyn, NY 11206, USA',
              'attrs' => 'style="width: 100%;" id="marker_opts_address"',
								...
								<tr>
									...
									<td>
										<?php echo htmlGmp::wpKsesHtml(
            htmlGmp::text('marker_opts[coord_x]', [
              'value' => '',
              ...
              'attrs' => 'style="width: 100%;" id="marker_opts_coord_x"',
								...
								<tr>
									...
									<td>
										<?php echo htmlGmp::wpKsesHtml(
            htmlGmp::text('marker_opts[coord_y]', [
              'value' => '',
              ...
              'attrs' => 'style="width: 100%;" id="marker_opts_coord_y"',
								...
								<tr>
									...
									<td>
										<div style="width: 100%;">
											<?php echo htmlGmp::wpKsesHtml(
             htmlGmp::selectlist('marker_opts[marker_group_id]', [
            ...
            htmlGmp::checkbox('marker_opts[params][marker_link]', [
              ...
              'attrs' => 'id="marker_link" onclick="gmpAddLinkOptions()"',
										...
										<div id="link_options" style="display: none;">
											<?php echo htmlGmp::wpKsesHtml(
             htmlGmp::text('marker_opts[params][marker_link_src]', [
               'value' => '',
               'attrs' => 'style="width: 90%; float: right; margin: 0px 0px 10px 0px;"',
											...
											<div style="clear: both;"></div>
											<?php echo htmlGmp::wpKsesHtml(
             htmlGmp::checkbox('marker_opts[params][marker_link_new_wnd]', [
               'checked' => '',
             ]),
           ); ?>
											<span>
								...
								<tr>
									...
									<td>
										<?php echo htmlGmp::wpKsesHtml(
            htmlGmp::checkbox('marker_opts[params][show_description]', [
              'checked' => '',
            ]),
          ); ?>
									</td>
								...
								<tr>
									...
									<td>
										<?php echo htmlGmp::wpKsesHtml(
            htmlGmp::checkbox('marker_opts[params][description_mouse_hover]', [
              'checked' => '',
            ]),
          ); ?>
									</td>
								...
								<tr id="marker_opts_description_mouse_leave">
									...
									<td>
										<?php echo htmlGmp::wpKsesHtml(
            htmlGmp::checkbox('marker_opts[params][description_mouse_leave]', [
              'checked' => '',
            ]),
          ); ?>
									</td>
								...
								<tr>
									...
									<td>
										<?php echo htmlGmp::wpKsesHtml(
            htmlGmp::checkbox('marker_opts[params][clasterer_exclude]', [
              'checked' => '',
            ]),
          ); ?>
									</td>
								...
								<tr>
									<th scope="row">
											...
											<span class="tooltipContent" id="tooltip_12">
												<?php _e(
              'Display markers on the map by a selected period. A marker will automatically start to appear on the specified date and disappear automatically at the appointed time.',
              GMP_LANG_CODE,
            ); ?> </br> <a href='https://supsystic.com/example/markers-displaying-by-period/'>https://supsystic.com/example/markers-displaying-by-period/</a> </br></br> <img style='width:100%' src=''>
											</span>
								...
								<tr>
									...
									<td>
										<?php if ($this->isPro) {
            echo htmlGmp::wpKsesHtml(
              htmlGmp::text('marker_opts[period_date_from]', [
                'value' => '',
                'attrs' => 'id="markerPeriodDateFrom"',
								...
								<tr>
									...
									<td>
										<?php if ($this->isPro) {
            echo htmlGmp::wpKsesHtml(
              htmlGmp::text('marker_opts[period_date_to]', [
                'value' => '',
                'attrs' => 'id="markerPeriodDateTo"',
							...
							<?php echo htmlGmp::wpKsesHtml(htmlGmp::hidden('mod', ['value' => 'marker'])); ?>
							<?php echo htmlGmp::wpKsesHtml(htmlGmp::hidden('action', ['value' => 'save'])); ?>
							<?php echo htmlGmp::defaultNonceForAdminPanel(); ?>
							<?php echo htmlGmp::wpKsesHtml(htmlGmp::hidden('marker_opts[id]', ['value' => ''])); ?>
							<?php echo htmlGmp::wpKsesHtml(htmlGmp::hidden('marker_opts[map_id]', ['value' => $this->editMap ? esc_attr($this->map['id']) : ''])); ?>
							<?php echo htmlGmp::wpKsesHtml(htmlGmp::hidden('marker_opts[path]', ['value' => ''])); ?>
						</form>
					</div>
             ...
             htmlGmp::text('shape_opts[title]', [
              ...
              GMP_LANG_CODE,
										...
										<td>
											<?php echo htmlGmp::wpKsesHtml(
             htmlGmp::selectbox('shape_opts[type]', [
               'options' => [
									...
									<tr>
										<td colspan="2" style="padding: 0 10px 0 0;">
											<div class="gmpCommonShapeParam gmpParamLeft">
												...
												<?php echo htmlGmp::wpKsesHtml(
              htmlGmp::colorpicker('shape_opts[params][strokeColor]', [
                'value' => '',
              ]),
            ); ?>
											</div>
											<div class="gmpCommonShapeParam">
												...
												<?php echo htmlGmp::wpKsesHtml(
              htmlGmp::selectbox('shape_opts[params][strokeOpacity]', [
                'options' => [
                  '0' => 0,
                  '0.1' => 0.1,
                  '0.2' => 0.2,
                ...
                'value' => '',
											...
											<div class="gmpCommonShapeParam  gmpParamRight">
												...
												<?php echo htmlGmp::wpKsesHtml(
              htmlGmp::text('shape_opts[params][strokeWeight]', [
                'value' => '',
                'attrs' => 'style="width: 100%;"',
              ]),
            ); ?>
											...
											<div class="gmpPolygonShapeParam gmpParamLeft">
												...
												<?php echo htmlGmp::wpKsesHtml(
              htmlGmp::colorpicker('shape_opts[params][fillColor]', [
                'value' => '',
              ]),
            ); ?>
											</div>
											<div class="gmpPolygonShapeParam">
												...
												<?php echo htmlGmp::wpKsesHtml(
              htmlGmp::selectbox('shape_opts[params][fillOpacity]', [
                'options' => [
                  '0' => 0,
                  '0.1' => 0.1,
                  '0.2' => 0.2,
                ...
                'value' => '',
											...
											<div class="gmpPolygonShapeParam gmpPolygonShapeDesc">
												...
												<?php wp_editor('', 'shapeDescription', [
              'textarea_rows' => 10,
            ]); ?>
												<?php echo htmlGmp::wpKsesHtml(htmlGmp::hidden('shape_opts[description]', ['value' => ''])); ?>
											</div>
										</td>
									</tr>
									<tr>
             ...
             GMP_LANG_CODE,
												...
												<div style="clear: both;">
													<div style="display: inline-block; width: 50%;">
														<label for="shape_opts_address">
															<?php _e('Address', GMP_LANG_CODE); ?>
															<?php echo htmlGmp::text('shape_opts[coords][0][address]', [
                 'value' => '',
                 'placeholder' => '603 Park Avenue, Brooklyn, NY 11206, USA',
                 'attrs' => 'class="gmpShapeAddress" data-type="address" style="width: 100%;" disabled="disabled"',
													...
													<div style="display: inline-block; width: 20%;">
														<label for="shape_opts_coord_x">
															<?php _e('Latitude', GMP_LANG_CODE); ?>
															<?php echo htmlGmp::text('shape_opts[coords][0][coord_x]', [
                 'value' => '',
                 'placeholder' => '40.69827799999999',
                 'attrs' => 'class="gmpShapeCoordX" data-type="coord_x" style="width: 100%;" disabled="disabled"',
													...
													<div style="display: inline-block; width: 20%;">
														<label for="shape_opts_coord_y">
															<?php _e('Longitude', GMP_LANG_CODE); ?>
															<?php echo htmlGmp::text('shape_opts[coords][0][coord_y]', [
                 'value' => '',
                 'placeholder' => '-73.95141139999998',
                 'attrs' => 'class="gmpShapeCoordY" data-type="coord_y" style="width: 100%;" disabled="disabled"',
													...
													<div style="display: none; width: 10%;">
														<label for="shape_opts_radius">
															...
															<?php echo htmlGmp::text('shape_opts[coords][0][radius]', [
                 'value' => '',
                 'placeholder' => '10000',
                 'attrs' => 'class="gmpShapeRadius" data-type="radius" data-def="100000" style="width: 100%;" disabled="disabled"',
								...
								<?php echo htmlGmp::wpKsesHtml(htmlGmp::hidden('mod', ['value' => 'shape'])); ?>
								<?php echo htmlGmp::wpKsesHtml(htmlGmp::hidden('action', ['value' => 'save'])); ?>
								<?php echo htmlGmp::defaultNonceForAdminPanel(); ?>
								<?php echo htmlGmp::wpKsesHtml(htmlGmp::hidden('shape_opts[id]', ['value' => ''])); ?>
								<?php echo htmlGmp::wpKsesHtml(htmlGmp::hidden('shape_opts[map_id]', ['value' => $this->editMap ? esc_attr($this->map['id']) : ''])); ?>
							</form>
						<?php } else {echo $promoData['gmpShapeTab']['content'];} ?>
					</div>
            ...
            GMP_LANG_CODE,
								...
								<tr>
									...
									<td>
										<?php echo htmlGmp::wpKsesHtml(
            htmlGmp::text('heatmap_opts[params][radius]', [
              'value' => '',
              'attrs' => 'style="width: 100%;"',
            ]),
          ); ?>
								...
								<tr>
									...
									<td>
										<?php echo htmlGmp::wpKsesHtml(
            htmlGmp::selectbox('heatmap_opts[params][opacity]', [
              'options' => [
                '0' => 0,
                '0.1' => 0.1,
                '0.2' => 0.2,
              ...
              'attrs' => 'style="width: 100%;"',
								...
								<tr>
									...
									<td>
										...
										<?php echo htmlGmp::wpKsesHtml(htmlGmp::hidden('heatmap_opts[params][gradient][]', ['value' => '', 'attrs' => 'class="firstHeatmapColor"'])); ?>
										<div id="gmpHeatmapGradientContainer"></div>
									</td>
								</tr>
							</table>
							<?php echo htmlGmp::wpKsesHtml(htmlGmp::hidden('mod', ['value' => 'heatmap'])); ?>
							<?php echo htmlGmp::wpKsesHtml(htmlGmp::hidden('action', ['value' => 'save'])); ?>
							<?php echo htmlGmp::defaultNonceForAdminPanel(); ?>
							<?php echo htmlGmp::wpKsesHtml(htmlGmp::hidden('heatmap_opts[id]', ['value' => ''])); ?>
							<?php echo htmlGmp::wpKsesHtml(htmlGmp::hidden('heatmap_opts[map_id]', ['value' => $this->editMap ? esc_attr($this->map['id']) : ''])); ?>
						</form>
					<?php } else {echo $promoData['gmpHeatmapTab']['content'];} ?>
				</div>
									...
									<tr>
										...
										<td>
											<div style="margin-top: 10px">
												...
												<?php echo htmlGmp::wpKsesHtml(
              htmlGmp::selectbox('route_opts[travel_mod]', [
                'options' => [
                ...
                'attrs' => 'style="width: 120px;" id="route_opts_travel_mod"',
											...
											<div style="margin-top: 10px">
												...
												<?php echo htmlGmp::wpKsesHtml(
              htmlGmp::selectbox('route_opts[optimize_path]', [
                'options' => [
											...
											<div>
												<div style="clear: both;">
													<div class="sup-col sup-w-50" style="margin-top: 10px">
														...
														<?php echo htmlGmp::wpKsesHtml(
                htmlGmp::text('route_opts[start_point_address]', [
                  ...
                  'attrs' => 'style="width: 100%;" id="route_opts_start_point_address"',
														...
														<?php echo htmlGmp::wpKsesHtml(
                htmlGmp::textarea('route_opts[start_point_desc]', [
											...
											<div>
												<div style="clear: both;">
													<div class="sup-col sup-w-50" style="margin-top: 10px">
														...
														<?php echo htmlGmp::wpKsesHtml(
                htmlGmp::text('route_opts[end_point_address]', [
                  ...
                  'attrs' => 'style="width: 100%;" id="route_opts_end_point_address"',
														...
														<?php echo htmlGmp::wpKsesHtml(
                htmlGmp::textarea('route_opts[end_point_desc]', [
										...
										<td>
											...
											<div class="waypointRouterRow waypointRouterRowCopy" style="display:none;">
													<div class="sup-col sup-w-50" style="margin-top: 10px">
														...
														<?php echo htmlGmp::wpKsesHtml(
                htmlGmp::text('route_opts[router_points_address][]', [
                  'value' => '',
                  'placeholder' => '',
                  'attrs' => 'class="router_points_address" style="width: 100%;"',
														...
														<?php echo htmlGmp::wpKsesHtml(
                htmlGmp::textarea('route_opts[router_points_title][]', [
                  'value' => '',
                  'textarea_rows' => 10,
                  'placeholder' => '',
               ...
               continue;
                ...
                htmlGmp::textarea('route_opts[router_points_title][]', [
                  ...
                  'attrs' => 'class="router_points_title" style="width: 100%;"',
							...
							<?php echo htmlGmp::wpKsesHtml(htmlGmp::hidden('pl', ['value' => 'gmp'])); ?>
							<?php echo htmlGmp::wpKsesHtml(htmlGmp::hidden('reqType', ['value' => 'ajax'])); ?>
							<?php echo htmlGmp::wpKsesHtml(htmlGmp::hidden('mod', ['value' => 'heatmap'])); ?>
							<?php echo htmlGmp::wpKsesHtml(htmlGmp::hidden('action', ['value' => ''])); ?>
							<?php echo htmlGmp::defaultNonceForAdminPanel(); ?>
							<?php echo htmlGmp::wpKsesHtml(htmlGmp::hidden('url', ['value' => ''])); ?>
							<?php echo htmlGmp::wpKsesHtml(htmlGmp::hidden('json', ['value' => ''])); ?>
							<?php echo htmlGmp::wpKsesHtml(htmlGmp::hidden('route_opts[map_id]', ['value' => $this->editMap ? esc_attr($this->map['id']) : ''])); ?>
						</form>
					<?php } else {echo $promoData['gmpRouterTab']['content'];} ?>
				</div>
				</div>
				<div class="supsistic-half-side-box" style="position: relative;">
				<div id="gmpMapRightStickyBar" class="supsystic-sticky">
					...
					<div class="gmpMapProControlsCon" id="gmpMapProControlsCon_<?php echo esc_attr($this->viewId); ?>">
						<?php dispatcherGmp::doAction('addAdminMapBottomControls', $this->editMap ? $this->map : []); ?>
					</div>
					<?php echo htmlGmp::wpKsesHtml(htmlGmp::hidden('rand_view_id', ['value' => esc_attr($this->viewId), 'attrs' => 'id="gmpViewId"'])); ?>
...
<div id="gmpIconsWnd" style="display: none;">
	<ul class="iconsList">
		<?php foreach ($this->icons as $icon) { ?>
			<?php if (!in_array($icon['title'], ['marker', 'flag', 'pin', 'star'], true)): ?>
	...
	<ul id="gmpMml">
		...
		<li class="gmpMmlElement gmpMmlElement-<?php echo esc_attr($lKey); ?>" data-key="<?php echo esc_attr($lKey); ?>">
			...
			<div class="gmpMmlElementBtnShell">
				<a href="<?php echo frameGmp::_()
      ->getModule('supsystic_promo')
      ->generateMainLink('utm_source=plugin&utm_medium=marker_list_' . esc_attr($lKey) . '&utm_campaign=googlemaps'); ?>" target="_blank" class="button button-primary gmpMmlApplyBtn" data-apply-label="<?php _e('Apply', GMP_LANG_CODE); ?>" data-active-label="<?php _e('Selected', GMP_LANG_CODE); ?>">
