jQuery(document).ready(function () {
  ...
  jQuery('#gmpGmapRemoveGroupBtn').click(function () {
    ...
    var confirmMsg = listIds.length > 1 ? toeLangGmp('Are you sur want to remove ' + listIds.length + ' Maps?') : toeLangGmp('Are you sure want to remove "' + mapLabel + '" Map?');
  ...
  jQuery('#gmpGmapCloneGroupBtn').click(function () {
    ...
    var confirmMsg = listIds.length > 1 ? toeLangGmp('Are you sur want to clone ' + listIds.length + ' Maps?') : toeLangGmp('Are you sure want to clone "' + mapLabel + '" Map?');
    if (confirm(confirmMsg)) {
      jQuery.sendFormGmp({
        btn: this,
