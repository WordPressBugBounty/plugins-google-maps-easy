  ...
  g_gmpGrid
    .jqGrid({
      ...
      loadComplete: function (res) {
        if (g_gmpGridData === null) g_gmpGridData = res.rows;
...
function gmpResetMarkerForm() {
  ...
  if (jQuery('#gmpMarkerForm input[name="marker_opts[params][description_mouse_hover]"]').prop('checked') === false) gmpHideCloseDescriptionCheckbox();
