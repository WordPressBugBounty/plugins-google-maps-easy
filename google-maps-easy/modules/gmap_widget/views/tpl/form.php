...
<div class="gmpWidgetRow gmpMapRow">
    ...
    htmlGmp::selectbox($this->widget->get_field_name('id'), [
...
<div class="gmpWidgetRow">
	...
	<div class="gmpWidgetRowCell gmpLastCell">
		<?php echo htmlGmp::wpKsesHtml(
    htmlGmp::text($this->widget->get_field_name('width'), [
...
<div class="gmpWidgetRow">
	...
	<div class="gmpWidgetRowCell gmpLastCell">
		<?php echo htmlGmp::wpKsesHtml(
    htmlGmp::text($this->widget->get_field_name('height'), [
...
<div class="gmpWidgetRow">
	...
	<div class="gmpWidgetRowCell gmpLastCell">
		<?php echo htmlGmp::wpKsesHtml(
    htmlGmp::text($this->widget->get_field_name('map_center'), [
...
<div class="gmpWidgetRow">
	...
	<div class="gmpWidgetRowCell gmpLastCell">
		<?php echo htmlGmp::wpKsesHtml(
    htmlGmp::text($this->widget->get_field_name('zoom'), [
...
<div class="gmpWidgetRow">
	...
	<div class="gmpWidgetRowCell gmpLastCell">
		<?php echo htmlGmp::wpKsesHtml(
    htmlGmp::checkbox($this->widget->get_field_name('display_as_img'), [
      ...
      'checked' => isset($this->data['display_as_img']),
		...
		<div class="gmpWidgetSuboptions" id="<?php echo esc_attr($this->widget->get_field_id('img_params_shell')); ?>" style="display: none;">
			<div class="gmpWidgetSuboptionsCell">
				...
				<?php echo htmlGmp::wpKsesHtml(
      htmlGmp::text($this->widget->get_field_name('img_width'), [
        ...
        'value' => esc_attr($this->data['img_width']),
			...
			<div class="gmpWidgetSuboptionsCell">
				...
				<?php echo htmlGmp::wpKsesHtml(
      htmlGmp::text($this->widget->get_field_name('img_height'), [
