jQuery(document).ready(function () {
  ...
  jQuery(document)
    .on('mouseover', '#gmpMgrTbl .jqtree-element.jqtree_common', function () {
  ...
  jQuery('#gmpMgrRemoveGroupBtn').click(function () {
    ...
    confirmMsg = listIds.length > 1 ? toeLangGmp('Are you sur want to remove ' + listIds.length + ' marker categories?') : toeLangGmp('Are you sure want to remove "' + mapLabel + '" marker category?');
