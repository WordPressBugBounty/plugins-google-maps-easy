...
class templatesGmp extends moduleGmp
{
  ...
  public function loadAdminCoreJs()
  {
    ...
    frameGmp::_()->addScript('jquery-ui-slider', '', ['jquery']);
    frameGmp::_()->addScript('wp-color-picker');
    frameGmp::_()->addScript('icheck', GMP_JS_PATH . 'icheck.min.js');
    frameGmp::_()->addScript('jquery-ui-autocomplete', '', ['jquery']);
  ...
  public function loadCoreJs()
  {
    ...
    if (!$loaded) {
      ...
      frameGmp::_()->addScript('commonGmp', GMP_JS_PATH . 'common.js', ['jquery']);
      frameGmp::_()->addScript('coreGmp', GMP_JS_PATH . 'core.js', ['jquery']);
  ...
  {
    $this->_styles = [
      'styleGmp' => ['path' => GMP_CSS_PATH . 'style.css', 'for' => 'admin'],
      'supsystic-uiGmp' => ['path' => GMP_CSS_PATH . 'supsystic-ui.css', 'for' => 'admin'],
      'dashicons' => ['for' => 'admin'],
      'icheck' => ['path' => GMP_CSS_PATH . 'jquery.icheck.css', 'for' => 'admin'],
  ...
  public function loadGoogleFont($font)
  {
    ...
    if (!isset($loaded[$font])) {
      frameGmp::_()->addStyle('google.font.' . str_replace([' '], '-', $font), 'https://fonts.googleapis.com/css?family=' . urlencode($font));
      $loaded[$font] = 1;
    }
  }
}
