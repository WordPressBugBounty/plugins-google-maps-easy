...
define(
    "GMP_TEMPLATES_PATH",
    GMP_PLUGINS_URL . "/" . GMP_PLUG_NAME . "/templates/"
);
...
define("GMP_VERSION_PLUGIN", "1.11.24"); //GMP_VERSION is pre-defined constant for PHP GMP module http://php.net/manual/en/book.gmp.php
